  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (res.access_token) {
        ...
        document.cookie = `auth-token=${res.access_token}; path=/; max-age=86400;`;
      ...
      setErrors({ ...errors, password: err.message || 'Login failed. Please check your credentials.' });
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="fade-up">
      ...
      <div style={{
        ...
        <span style={{
          fontSize: 11, color: 'var(--text-subtle)', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.5px'
        }}>OR</span>
        <div style={{ flex: 1, height: 1, background: 'var(--border-soft)' }} />
      </div>
      ...
      <div style={{ display: 'flex', gap: 12, marginBottom: 24 }}>
        <AuthButton variant="oauth" fullWidth id="google-login">
        ...
        <AuthButton variant="oauth" fullWidth id="github-login">
          <Github size={18} />
          GitHub
        </AuthButton>
      </div>
